...
class Instagram implements ExperimentsInterface
{
    ...
    /**
     * Authorization Key for Private Subscription features.
     *
     * @var string
     */
    public $authKey;
     ...
     * @param string $authKey        Authorization Key for Private Subscription features.
     *
        ...
        if (!$this->isMaybeLoggedIn || $forceLogin) {
            ...
            try {
                $request = $this->request('accounts/login/')
                    ...
                    ->addPost('enc_password', $this->password)
                ...
                if ($e->hasResponse() && $e->getResponse()->isTwoFactorRequired()) {
                    ...
                    if ($e->getResponse()->getInvalidCredentials() === true) {
